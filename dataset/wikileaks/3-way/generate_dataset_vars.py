...
print("Secret documents: "+str(len(X_sec)))
print("---")
...
print("Avg. Secret record length: "+str(float(secr_len)/secr_docs))
print("---")
print("Number of words that only appear once: "+str(single_instance_ctr))
print("---")
